<template>
  <main id="content" :class="main" v-if="(typeof main != 'undefined')">
    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-between py-3 gx-3">
            ...
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input type="search" name="query" id="query" class="form-control form-control-sm rounded-pill app-color" v-model="query" placeholder="Search any city" @keypress="searchWeather">
                </div>
            </div>
            <div class="col-2 d-flex justify-content-end">
                <button class="btn btn-light btn-sm rounded-circle shadow-sm" @click="getWeather" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="Get your current weather">
        ...
        <!-- Weather Info -->
        <div class="d-flex justify-content-center" v-if="(typeof main != 'undefined')">
        ...
        <div class="d-md-flex align-items-center justify-content-center">
            <div class="d-block text-center">
                <img src="../src/assets/weather-icons/10d.svg" :alt="description" height="250" width="250" class="weather-icon pl-1">
            </div>
              ...
              <nav class="nav d-flex justify-content-between">
                  <a class="scrolling-weather-card" href="#">
                      <div class="d-flex flex-column justify-content-between align-items-center">
                          <h5 class="fw-bold small-xs">24°C</h5>
                          <img src="../src/assets/weather-icons/10d.svg" alt="icon" width="30" height="30">
                          <h6 class="small-xs text-capitalize mb-0">sunday</h6>
                      </div>
                  </a>
                  <a class="scrolling-weather-card" href="#">
                      <div class="d-flex flex-column justify-content-between align-items-center">
                          <h5 class="fw-bold small-xs">26°C</h5>
                          <img src="../src/assets/weather-icons/01d.svg" alt="icon" width="30" height="30">
                          <h6 class="small-xs text-capitalize mb-0">monday</h6>
                      </div>
                  </a>
                  <a class="scrolling-weather-card active" href="#">
                      <div class="d-flex flex-column justify-content-between align-items-center">
                          <h5 class="fw-bold small-xs">17°C</h5>
                          <img src="../src/assets/weather-icons/10d.svg" alt="icon" width="30" height="30">
                          <h6 class="small-xs text-capitalize mb-0">tuesday</h6>
                      </div>
                  </a>
                  <a class="scrolling-weather-card" href="#">
                      <div class="d-flex flex-column justify-content-between align-items-center">
                          <h5 class="fw-bold small-xs">19°C</h5>
                          <img src="../src/assets/weather-icons/11d.svg" alt="icon" width="30" height="30">
                          <h6 class="small-xs text-capitalize mb-0">wednesday</h6>
                      </div>
                  </a>
                  <a class="scrolling-weather-card" href="#">
                      <div class="d-flex flex-column justify-content-between align-items-center">
                          <h5 class="fw-bold small-xs">21°C</h5>
                          <img src="../src/assets/weather-icons/13d.svg" alt="icon" width="30" height="30">
                          <h6 class="small-xs text-capitalize mb-0">thursday</h6>
                      </div>
                  </a>
              </nav>
          </div>
 ...
 export default {
  ...
  methods: {
    ...
    getWeather(){
      ...
      fetch(`${this.base_url}forecast?lat=${this.lat}&lon=${this.lon}&units=metric&appid=${this.api_key}`)
      .then(res => res.json())
      .then((data) => {
        console.log(data);
        ...
        for(var i = 0; i < forecast.length; i++){
          this.output += `
            <div class="text-center">
              <h5 class="small-xs fw-bold">${Math.round(forecast[i].main.temp)}°C</h5>
              <img src="../src/assets/weather-icons/${forecast[i].weather[0].icon}.svg" class="weather-icon" alt="${forecast[i].weather[0].description}"/>
              <h6 class="small-xs">${this.stringToDay(forecast[i].dt_txt)}</h6>
            </div>
          `;
        }
